...
describe('fetchStockById', () => {
  ...
  it('should fetch a stock by ID using the configured API_URL', async () => {
    ...
    expect(global.fetch).toHaveBeenCalledWith('https://stockdashboard.ddnsfree.com/api/stocks/123');
  ...
  it('should return null when stock is not found (404)', async () => {
    ...
    expect(global.fetch).toHaveBeenCalledWith('https://stockdashboard.ddnsfree.com/api/stocks/999');
