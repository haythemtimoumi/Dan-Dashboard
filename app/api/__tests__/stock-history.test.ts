...
describe('Stock History API', () => {
  it('should return 400 for invalid ID format', async () => {
    const request = new NextRequest(new URL('http://locahost:3000/api/stocks/abc/history'));
  ...
  it('should return 404 for non-existent stock', async () => {
    const request = new NextRequest(new URL('http://locahost:3000/api/stocks/999/history'));
  ...
  it('should return historical data for stock with ID 15289', async () => {
    const request = new NextRequest(new URL('http://locahost:3000/api/stocks/15289/history'));
  ...
  it('should respect date range parameters', async () => {
    ...
    const url = `http://locahost:3000/api/stocks/1/history?from=${fromDate}&to=${toDate}`;
