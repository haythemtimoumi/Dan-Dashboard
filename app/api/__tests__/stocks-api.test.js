...
describe('Stock API Routes', () => {
  ...
  test('GET /api/stocks/filter-by-date-source returns stocks filtered by date and source', async () => {
    ...
    const mockRequest = {
      url: 'http://162.248.100.66:3000/api/stocks/filter-by-date-source?date=06%2F20%2F2023&source=Rule1'
    };
  ...
  test('GET /api/stocks/filter-by-date-source with no stocks returns proper metadata', async () => {
    ...
    const mockRequest = {
      url: 'http://162.248.100.66:3000/api/stocks/filter-by-date-source?date=01%2F01%2F2000&source=Rule1'
    };
