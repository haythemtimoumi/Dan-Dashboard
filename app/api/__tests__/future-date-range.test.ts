...
describe('Future Date Range API Tests', () => {
  ...
  it('should return stocks for future date range (06/06/2025 to 07/06/2025)', async () => {
    const request = new Request('http://162.248.100.66:3000/api/stocks/date-range?startDate=06/06/2025&endDate=07/06/2025');
  ...
  it('should return empty array for future date range with no stocks', async () => {
    const request = new Request('http://162.248.100.66:3000/api/stocks/date-range?startDate=08/01/2025&endDate=09/01/2025');
    await getStocksByDateRange(request);
