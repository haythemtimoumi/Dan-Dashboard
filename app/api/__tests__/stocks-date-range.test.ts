...
describe('Stocks Date Range API', () => {
  ...
  describe('GET /api/stocks/date-range', () => {
    ...
    it('should return stocks filtered by date range with MM/DD/YYYY format', async () => {
      const request = new Request('https://stockdashboard.ddnsfree.com/api/stocks/date-range?startDate=01/01/2023&endDate=06/30/2023');
      await getStocksByDateRange(request);
    ...
    it('should return stocks filtered by date range with YYYY-MM-DD format', async () => {
      const request = new Request('https://stockdashboard.ddnsfree.com/api/stocks/date-range?startDate=2023-01-01&endDate=2023-06-30');
      await getStocksByDateRange(request);
    ...
    it('should return 400 for invalid date format', async () => {
      const request = new Request('https://stockdashboard.ddnsfree.com/api/stocks/date-range?startDate=invalid&endDate=invalid');
      await getStocksByDateRange(request);
  ...
  describe('GET /api/stocks/highlighted/filter', () => {
    it('should return all highlighted stocks if no date range is provided', async () => {
      const request = new Request('https://stockdashboard.ddnsfree.com/api/stocks/highlighted/filter');
    ...
    it('should return highlighted stocks filtered by date range with YYYY-MM-DD format', async () => {
      const request = new Request('https://stockdashboard.ddnsfree.com/api/stocks/highlighted/filter?startDate=2023-01-01&endDate=2023-03-01');
      await getHighlightedStocksByDateRange(request);
    ...
    it('should return highlighted stocks filtered by date range with MM/DD/YYYY format', async () => {
      const request = new Request('https://stockdashboard.ddnsfree.com/api/stocks/highlighted/filter?startDate=01/01/2023&endDate=03/01/2023');
      await getHighlightedStocksByDateRange(request);
    ...
    it('should return empty array if no highlighted stocks in date range', async () => {
      const request = new Request('https://stockdashboard.ddnsfree.com/api/stocks/highlighted/filter?startDate=2024-01-01&endDate=2024-03-01');
      await getHighlightedStocksByDateRange(request);
    ...
    it('should return 400 for invalid date format', async () => {
      const request = new Request('https://stockdashboard.ddnsfree.com/api/stocks/highlighted/filter?startDate=invalid&endDate=invalid');
      await getHighlightedStocksByDateRange(request);
