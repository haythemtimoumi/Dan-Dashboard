...
describe('Date Range API', () => {
  ...
  it('should handle valid date parameters in MM/DD/YYYY format', async () => {
    ...
    const request = new Request('http://locahost:3000/api/stocks/date-range?startDate=01/01/2023&endDate=12/31/2023');
  ...
  it('should handle valid date parameters in YYYY-MM-DD format', async () => {
    // Test with valid date parameters
    const request = new Request('http://locahost:3000/api/stocks/date-range?startDate=2023-01-01&endDate=2023-12-31');
  ...
  it('should handle invalid date format', async () => {
    ...
    const request = new Request('http://locahost:3000/api/stocks/date-range?startDate=invalid&endDate=2023-12-31');
