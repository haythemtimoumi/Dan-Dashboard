...
describe('Highlighted Stocks Filter API', () => {
  ...
  it('should handle valid date parameters in MM/DD/YYYY format', async () => {
    ...
    const request = new Request('https://stockdashboard.ddnsfree.com/api/stocks/highlighted/filter?startDate=01/01/2023&endDate=12/31/2023');
  ...
  it('should handle valid date parameters in YYYY-MM-DD format', async () => {
    // Test with valid date parameters
    const request = new Request('https://stockdashboard.ddnsfree.com/api/stocks/highlighted/filter?startDate=2023-01-01&endDate=2023-12-31');
  ...
  it('should handle invalid date format', async () => {
    ...
    const request = new Request('https://stockdashboard.ddnsfree.com/api/stocks/highlighted/filter?startDate=invalid&endDate=2023-12-31');
  ...
  it('should return empty array for no matching stocks', async () => {
    ...
    const request = new Request('https://stockdashboard.ddnsfree.com/api/stocks/highlighted/filter?startDate=2050-01-01&endDate=2050-12-31');
