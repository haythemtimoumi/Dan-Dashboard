  ...
  const SortableHeader = ({ label, field }: { label: string; field: string }) => (
    <th 
      ...
      className={clsx(
        ...
        sortBy === field ? "text-yellow-700" : "text-gray-700 hover:text-yellow-600"
      )}
          ...
          <div className="rounded-xl bg-white p-6 shadow-lg border border-gray-100">
            <div className="flex justify-between items-center mb-6">
              <div className="animate-pulse flex items-center gap-2">
                <div className="h-6 w-6 bg-yellow-200 rounded-full"></div>
                <div className="h-8 w-48 bg-gray-200 rounded-lg"></div>
              </div>
              <div className="h-10 w-24 bg-yellow-100 rounded-lg animate-pulse"></div>
            </div>
        ...
        <div className="rounded-xl bg-white p-6 shadow-lg border border-gray-100">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg px-4 py-2 flex items-center gap-2">
              ...
              <span className="text-yellow-800 font-medium">{stocks.length} highlighted stocks</span>
            </div>
          </div>
          
          {/* Date filter */}
          <div className="mb-8 bg-gradient-to-r from-yellow-50 to-amber-50 p-6 rounded-xl border border-yellow-100 shadow-sm">
            ...
            <form onSubmit={handleDateFilterChange} className="grid grid-cols-1 gap-6 md:grid-cols-3">
              <div className="col-span-1">
                ...
                <div className="relative">
                  <DatePicker
                    ...
                    className={clsx(
                      "block w-full rounded-lg border py-2.5 px-4 pl-10 text-sm shadow-sm focus:ring-2 focus:ring-yellow-500/30 bg-white",
                      dateError ? "border-red-300 focus:border-red-500" : "border-gray-200 focus:border-yellow-500"
                    )}
                    ...
                    todayButton="Today"
                  />
                  <CalendarIcon className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-yellow-500" />
                </div>
              </div>
              ...
              <div className="col-span-1 flex items-end gap-3">
                <button
                  ...
                  className="rounded-lg bg-amber-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-amber-700 flex-grow shadow-sm transition-all duration-200 hover:shadow"
                >
                ...
                <button
                  type="submit"
                  className="rounded-lg bg-yellow-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-yellow-700 shadow-sm transition-all duration-200 hover:shadow flex items-center justify-center"
                >
            ...
            <>
              ...
              <div className="md:hidden space-y-4">
                {paginatedStocks.map((stock) => (
                  <div
                    key={stock.id}
                    className="w-full rounded-xl bg-white p-5 shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer hover:bg-yellow-50 border border-gray-100"
                    onClick={(e) => {
                      e.preventDefault();
                      ...
                      <div className="flex items-center justify-between pt-2 border-t border-gray-100">
                        ...
                        <div>
                          <button
                            ...
                            className="rounded-lg bg-yellow-100 px-3 py-1.5 text-sm font-medium text-yellow-700 hover:bg-yellow-200 transition-colors"
                          >
                            View Details
                          </button>
                        </div>
              ...
              <div className="hidden md:block overflow-hidden rounded-xl border border-gray-200">
                <table className="min-w-full text-gray-900 border-collapse">
                  <thead>
                    <tr className="bg-gradient-to-r from-yellow-50 to-amber-50 text-left text-sm font-medium">
                  ...
                  <tbody className="bg-white divide-y divide-gray-100">
                    {paginatedStocks.map((stock) => (
                      <tr
                        key={stock.id}
                        className="w-full text-sm hover:bg-yellow-50 transition-all duration-200 cursor-pointer"
                        onClick={(e) => {
                          e.preventDefault();
                          router.push(`/dashboard/highlighted/${stock.id}`);
                        }}
                      >
                        <td className="px-4 py-3.5 whitespace-nowrap">
                          <div className="flex items-center gap-2">
                            <div className="h-8 w-8 rounded-full bg-yellow-100 flex items-center justify-center text-yellow-700 font-medium text-xs">
                              {stock.ticker.substring(0, 2)}
                            </div>
                            <div>
