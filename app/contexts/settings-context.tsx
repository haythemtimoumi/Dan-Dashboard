...
const translations = {
  en: {
    ...
    sourceLabel: 'Source:',
    manualSource: 'Manual',
    guruListSource: 'Guru List',
    targetSource: 'Target',
    monitorSource: 'Monitor',
    deleteTicker: 'Delete ticker',
    confirmDeleteTicker: 'Are you sure you want to delete this ticker?',
    tickerDeleted: 'Ticker deleted successfully',
    failedToDeleteTicker: 'Failed to delete ticker',
    addToSource: 'Add to {source}',
    replaceSource: 'Replace {source}',
    enterTickerSymbols: 'Enter Ticker Symbols',
    symbols: 'symbols',
    tickersUpdated: 'Tickers updated successfully',
    failedToUpdateTickers: 'Failed to update tickers',
    ...
    manageScrapingServices: 'Manage and control scraping services',
    schedule: 'Schedule',
    daily: 'Daily',
    weekly: 'Weekly',
    monthly: 'Monthly',
    ...
    checkConnectionToScrapingServer: 'Check connection to scraping server',
    retry: 'Retry',
    ...
    customSchedule: 'Custom (9:00 AM)',
    testConnection: 'Test Connection',
    connectionSuccessful: 'Successfully connected to scraping server',
    connectionFailed: 'Failed to connect to scraping server',
    monthlyScrapers: 'Monthly Scrapers',
    dailyScrapers: 'Daily Scrapers',
    hourlyScrapers: 'Hourly Scrapers',
    mainScraperConfig: 'Main Scraper Configuration',
    configureMainScraper: 'Configure main scraper settings',
    editConfig: 'Edit Config',
    saveConfig: 'Save Config',
    configSaved: 'Configuration saved successfully',
    failedToSaveConfig: 'Failed to save configuration',
    comingSoon: 'Coming Soon',
    apiInDevelopment: 'API in development',
  ...
  fr: {
    ...
    runningService: 'En cours',
    locked: 'Verrouillé',
    sourceLabel: 'Source:',
    manualSource: 'Manuel',
    guruListSource: 'Liste Guru',
    targetSource: 'Cible',
    monitorSource: 'Moniteur',
    deleteTicker: 'Supprimer le symbole',
    confirmDeleteTicker: 'Êtes-vous sûr de vouloir supprimer ce symbole?',
    tickerDeleted: 'Symbole supprimé avec succès',
    failedToDeleteTicker: 'Échec de la suppression du symbole',
    addToSource: 'Ajouter à {source}',
    replaceSource: 'Remplacer {source}',
    enterTickerSymbols: 'Entrer les symboles',
    symbols: 'symboles',
    tickersUpdated: 'Symboles mis à jour avec succès',
    failedToUpdateTickers: 'Échec de la mise à jour des symboles',
    ...
    // Scraper Management
    scraperManagement: 'Gestion du Scraper',
    manageScrapingServices: 'Gérer et contrôler les services de scraping',
    schedule: 'Planification',
    daily: 'Quotidien',
    weekly: 'Hebdomadaire',
    monthly: 'Mensuel',
    updateSchedule: 'Mettre à jour',
    run: 'Exécuter',
    running: 'En cours...',
    execute: 'Exécuter',
    noServicesAvailable: 'Aucun service disponible',
    checkConnectionToScrapingServer: 'Vérifiez la connexion au serveur de scraping',
    retry: 'Réessayer',
    failedToLoadServices: 'Échec du chargement des services',
    serviceStarted: 'Service démarré',
    failedToStartService: 'Échec du démarrage du service',
    scheduleUpdated: 'Planification mise à jour',
    failedToUpdateSchedule: 'Échec de la mise à jour de la planification',
    customSchedule: 'Personnalisé (9h00)',
    testConnection: 'Tester Connexion',
    connectionSuccessful: 'Connexion réussie au serveur de scraping',
    connectionFailed: 'Échec de la connexion au serveur de scraping',
    hourly: 'Horaire',
    monthlyScrapers: 'Scrapers Mensuels',
    dailyScrapers: 'Scrapers Quotidiens',
    hourlyScrapers: 'Scrapers Horaires',
    mainScraperConfig: 'Configuration du Scraper Principal',
    configureMainScraper: 'Configurer les paramètres du scraper principal',
    editConfig: 'Modifier Config',
    saveConfig: 'Sauvegarder Config',
    configSaved: 'Configuration sauvegardée avec succès',
    failedToSaveConfig: 'Échec de la sauvegarde de la configuration',
    comingSoon: 'Bientôt Disponible',
    apiInDevelopment: 'API en développement',
