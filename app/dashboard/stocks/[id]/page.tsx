...
export default async function StockDetailPage({ params }: { params: { id: string } }) {
  ...
  try {
    ...
    if (!stock) {
      console.log(`Stock with ID ${id} not found, showing user-friendly message`);
      // Uncomment the next line to enable automatic redirection to the stocks list
      // redirect('/dashboard/stocks');
      
      return (
        <div className="mt-6 rounded-lg bg-amber-50 p-6 text-center shadow-md">
          <h2 className="text-lg font-semibold text-amber-800">Stock Not Found</h2>
          <p className="mt-2 text-amber-700">The stock with ID {id} could not be found.</p>
          <div className="mt-4">
            <Link
              ...
              <div>
                ...
                <div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-md">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <p className="text-sm font-medium text-gray-500">Percentage Upside</p>
                        <p className="text-lg">{stock.pe}</p>
                      </div>
                      <div>
                        <p className="text-sm font-medium text-gray-500">Sticker Price</p>
    ...
    return (
      <div className="mt-6 rounded-lg bg-red-50 p-6 text-center shadow-md">
        ...
        <p className="mt-2 text-red-700">Failed to load stock details. Please try again later.</p>
        <div className="mt-4">
          <Link
            href="/dashboard/stocks"
            className="rounded-md bg-blue-500 px-4 py-2 text-sm font-medium text-white hover:bg-blue-600 transition-colors"
